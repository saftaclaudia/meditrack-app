    ...
    <div className="space-y-8">
      {profileIncomplete && (
        <button
          ...
          className="w-full text-left px-4 py-3 rounded-xl border border-dashed border-border-light dark:border-border-dark flec items-center justify-between group hover:border-primary transition-colors"
        >
          <div>
